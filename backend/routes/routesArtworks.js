...
router.use('/artwork/add', middlewares.isAuthentified)
...
//Uploader une image d'oeuvre
// router.post('/upload-artwork/', upload.single('oeuvre'), function (req, res, next) {
//   try {
//     console.log(req.body);
...
//     });
//     let fileArtwork = `INSERT INTO artworks (art_title, art_desc, art_picture, id_user, id_cate) VALUES ('${req.body.title}','${req.body.description}','${newFileName}','${req.body.id_user}', '${req.body.id_cate}') `
//     db.query(fileArtwork, function (err, result) {
//       if (err) throw err;
...
router.delete('/delete-artwork/:id_artwork', middlewares.isAuthentified, function (req, res) {
  try {
...
router.use('/update-artwork/:edit', middlewares.isAuthentified)
